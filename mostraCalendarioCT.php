 ...
 * DS-> LEANDRO BRITO
 */
    include_once './entidades/CalendarioCtSegSex.php';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="content-type" content="text/html;charset=utf-8" />
            <title>CALENDARIO SEGUNDA A SEXTA CURSOS TÉNICOS</title>
        <meta charset="UTF-8" />
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-6">
                        <div>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>CALENDARIO SEGUNDA A SEXTA CT</th>
                                    </tr>
                                    <tr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-6">
                        <div>
                            ...
                            <?php
                               $janiero = new CalendarioCtSegSex();
