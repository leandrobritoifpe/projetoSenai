 ...
 */
    ...
    $codFilial = 1;
    $codigoDocente = 83;
    $sql = "SELECT * FROM PHE_CALENDARIO_DOCENTE
            WHERE CODFILIAL = $codFilial
            AND CODIGODOCENTE = $codigoDocente";
        ...
        <div class="main clearfix">
           ...
           <div class="container">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-6">
                        <div>
                            ...
                            <?php
                               ...
                               $janiero->geraCalendario(01, $ano,$codFilial,83);
                               //echo $ano;
                            ?>
                        </div>
                    </div>
                     ...
                     <div class="col-md-3 col-sm-4 col-xs-6">
                        ...
                        <?php
                            ...
                            $fervereiro->geraCalendario(02, $ano, $codFilial,83);
                        ?>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-6">
                       <div>MARÇO</div>
                        <?php
                            ...
                            $marco->geraCalendario(03, $ano, $codFilial,83);
                        ?>
                   </div>
                    <div class="col-md-3 col-sm-4 col-xs-6">
                       <div>ABRIL</div>
			<?php
                            ...
                            $abril->geraCalendario(04, $ano, $codFilial,83);
                        ?>
                    </div> 
                </div>
                <br></br>
