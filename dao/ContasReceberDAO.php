...
{
	// Método que realiza um insert, ele pede como parâmetro um objeto do tipo ContasReceber
	public function InsertContasReceber(ContasReceber $ContasReceber)
	{
		...
		*/
		 ...
		 * E por isso temos que informar no método um objeto do tipo ContasReceber, já que essas propriedades
	...
	public function ShowClientes(ContasReceber $ContasReceber)
	{
		...
		*/
		...
		else 
		{
			...
			{
				/* 
				 * Temos o mesmo código de cima, mais com uma condição ($registros["id_cliente"] == $id ? 'selected=""' : '')
